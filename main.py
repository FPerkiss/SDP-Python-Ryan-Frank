...
house_price = []
property_id = []
page_number = 400 # The url goes up by 24 each time.

URL = f"https://www.rightmove.co.uk/property-for-sale/find.html?locationIdentifier=REGION%5E61307&index={page_number}&propertyTypes=&includeSSTC=false&mustHave=&dontShow=&furnishTypes=&keywords="
page = r.get(URL)
...
if numberOfListings >= lastListing:
    ...
    page_number = 48 # The url goes up by 24 each time.
